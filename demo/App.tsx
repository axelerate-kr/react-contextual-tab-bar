...
const UI = {
  ...
  ko: {
    ...
    lede: (
      <>
        탭을 누르면 <strong>네비게이션 바가 그 섹션의 탭들로 바뀝니다.</strong> 첫 번째 탭이 있던
        자리에는 뒤로가기가 들어옵니다. 이전 탭들은 원래 자리에서 사라지고 새 탭들은 새 자리에서
        나타나기 때문에, 두 줄이 잠깐 겹쳐 보입니다. 지금까지 나온 탭바 라이브러리는 탭이 고정돼 있고
        그 안에서 <em>인디케이터</em>만 움직입니다. 탭 자체가 바뀌는 건 없었습니다.
      </>
    ),
